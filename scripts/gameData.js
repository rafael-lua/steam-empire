...
export const infusionData = {
  ...
  weak: {
    ...
    getRequiredList: function(player) {
      const list = [
        { name: "Coal", amount: this.coal, has: player.coal >= this.coal },
        {
          name: "AP",
          amount: this.ap,
          has: player.achievementPoints >= this.ap
        },
    ...
    canUpgrade: function(player) {
      if (
        player.achievementPoints >= this.ap &&
...
export const nomadData = {
  sellCoal: {
    popupMessage:
      "Sell a limited amount of coal to a traveling nomad. Resets every 7 days",
    title: "Coal",
    value: 1,
    max: 50
  },
  ...
  map_1: {
    popupMessage:
      "Acquire knowledge of the surroundings, revealing all types of useful information, materials and possibilities",
    title: "Map #1",
    value: 50
  },
  craftingTools: {
    popupMessage:
      "Open the crafting capability, allowing the construction of buildings and instruments",
    title: "Crafting\nTools",
    value: 50
  },
  backpack: {
...
export const craftingsData = {
  tavern: {
    ...
    name: "tavern",
    popupMessage:
      "A small tavern with beer and accommodations. Travelers may want to stay permanently and they will be available for hiring. Population growth +1",
    icon: "tavern-sign",
    baseCost: 0.01,
    complexity: 100,
    target: 100,
